...
**BLOCK** on `posts/post4/BRIEF.md` (0e058a1). Verdict: `posts/post4/notes/referee-brief.md`;
re-derivations: `posts/post4/notes/rederivation/` (every steward number reproduces; two discrepancies are
constructs, not arithmetic). Seven blocking items, one pass by the lead:

1. The pp outcome makes the "unweighted" H1 test a five-task test (top mover 46.6% of variance,
