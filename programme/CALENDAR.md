...
|---|---|---|---|
| post1 | LL-07 | Is AI delegated more on low-wage work or on high-wage work? (frozen at Gate 1b) | **Gate 1b APPROVED 2026-09-17** (brief 9af7bad + re-verdict b4ad871; room/director-2026-09-17-gate-1b-post1-approved.md). Human's note: sharpen §2 why-it-matters at write-up with editor and lead (Stage 3, not before). Session 2.1 open: lead applies items 14–20, 23 → steward replicates → analyst prereg (P1–P9) → referee → **Gate 2a** |
...
|---|---|
| post1 | Human's Gate 1b note: the why-it-matters (§2) is to be sharpened at the write-up stage by the editor with the lead. |
...
| 2.1 post1 Stage 2 to Gate 2a | (running; updated at the gate) | lead items pass, steward replication, analyst prereg, referee prereg verdict (+ second-read on any revision) |
