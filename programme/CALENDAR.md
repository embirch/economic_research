...
|---|---|
| post1 | **AT GATE 3** (room/director-2026-09-17-gate-3-post1.md). Lead's why-it-matters note 31898a5 → editor draft 5519f06/c148bbe on `post1-draft` → referee PASS WITH CHANGES 67f1d66 (4 blocking, 12 should, 6 could) + analyst caption fix 283f346 → editor revision **e98d27a** (20/22) → second-read SIGN OFF e4c246d; analyst fig4 title sync 44e38a5 on main. Verifier PASS (222 bindings). Human opens and merges the PR. `site/tools/` builder+verifier now shared; page-build skill written. Footnote against BRIEF §9(4): declared-H4 has 80% power only up to ≈0.32 pp; the ≈0.5 pp is step (4)'s clause (posts/post1/notes/referee-prereg.md item 3). |
