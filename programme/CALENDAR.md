...
| 1.4 Briefs, batch 1 | `posts/post{1..5}/BRIEF.md` (lead); `posts/post{1..5}/notes/feasibility.md` (steward); editor framing note per brief; referee sweep per brief. **Gate 1b (batch 1)**: human approves posts 1–5. | in progress |
...
|---|---|---|---|
| post1 | LL-07 | — | brief in progress (batch 1) |
| post2 | LL-11 | — | brief in progress (batch 1) |
| post3 | LL-36 | — | brief in progress (batch 1) |
| post4 | LL-09 | — | brief in progress (batch 1) |
| post5 | LL-18 | — | brief in progress (batch 1) |
...
| 1.4 batch 1 | (running) | see the Gate 1b (batch 1) message |
