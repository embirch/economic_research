...
## 2026-09-21 · frame correction from the human's independent draft (not a rule): fieldwork timing

The pre-registration's §6 says fieldwork is "by convention in the first quarter of 2025". The national reference metadata show data collection mostly between late March and early August 2025 (DE 3 Mar–13 Jun; FR 24 Mar–20 Jun; SE 25 Mar–12 Jun; ES 31 Mar–13 Jul; PL 1 Apr–30 May; CZ and FI 7 Apr–3 Aug; LU 3 Jun–3 Aug; SK 2 May–27 Jun; AT Apr–Jul; RO 26 May–13 Jun; RS 15–28 Feb; EL Jul–Sep; DK's tables refer to Aug–Dec). "Recent use" therefore refers to windows spread across the first three quarters of 2025, and the country comparison is not a common calendar window. No rule, count or number changes; Figure 1's caption no longer says "early 2025"; the post's methodology and limitations carry the spread. Cross-check of the whole independent draft: `notes/crosscheck-independent-draft.md` (every number agrees).
